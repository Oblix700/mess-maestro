            ...
            {isLoading ? (
              ...
              filteredIngredients.map((ingredient) => (
                <TableRow key={ingredient.id}>
                  ...
                  <TableCell>{getCategoryName(ingredient.categoryId)}</TableCell>
                  <TableCell>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      ingredient.variants.length > 0 ? (
                        ingredient.variants.map((variant) => (
                          <Badge
                            key={variant.id}
                            variant="secondary"
                            className="group pl-3 pr-1 py-1 text-sm"
                          >
                            <span>
                              {variant.packagingSize}
                              {getUomName(variant.unitOfMeasureId)}
                            </span>
                            <button
                              onClick={() =>
                                confirmDeleteVariant(ingredient.id, variant)
                              }
                      ...
                      <Button
                        ...
                        size="icon"
                        className="h-6 w-6"
                        onClick={() => handleOpenAddVariantDialog(ingredient)}
                      >
                        <PlusCircle className="h-4 w-4" />
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedIngredient?.id
                ...
                : 'Create a new ingredient for the catalogue.'}
            </DialogDescription>
          </DialogHeader>
          {selectedIngredient && (
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the size and unit of measure for the new packaging option for{' '}
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewVariant({ ...newVariant, packagingSize: e.target.value })
                }
                className="col-span-3"
              />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewVariant({ ...newVariant, unitOfMeasureId: value })
                }
              >
                <SelectTrigger className="col-span-3">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              ingredient{' '}
              <span className="font-semibold">{ingredientToDelete?.name}</span> and
              all its variants.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this packaging size. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
